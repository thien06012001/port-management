...
public class ContainerCRUDViewMana {
    ...
    public static void addAContainer() {
        ...
        try {
            ...
            crud.addContainer(new Container(id, weight, type, status, currentUser.getAssociatedPort()));
            System.out.println("\033c");
    ...
    public static void updateAContainer() {
        ...
        try {
            ...
            if (!container.getLocationId().equals(currentUser.getAssociatedPort())) {
                System.out.println("This container is not in your port.");
                return;
            }
            ...
            crud.updateContainer(updateId,
                    new Container(updateId, updateWeight, updateType, updateStatus, currentUser.getAssociatedPort()));
            System.out.println("\033c");
    ...
    public void displayContainerCRUDMana() {
        ...
        while (true) {
            ...
            System.out.println("4. Update a container in port");
            System.out.println("5. Delete a container in port");
