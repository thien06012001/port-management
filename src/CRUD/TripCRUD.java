...
public class TripCRUD {
    ...
    public void addTrip(Trip trip) {
        ...
        if (vehicle.canMoveToDesPort(vehicle, departurePort)) {
            // The vehicle can move to the departure port, so proceed to add the trip
                    ...
                    case 2:
                        ...
                        if(status.equals("Completed")) {
                            if(vehicle.getType() == "Truck") {
                                ...
                                vehicleCRUD.updateVehicle(vehicleId, new Truck(vehicleId, truck.getName(), truck.getCurrentFuel(), truck.getFuelCapacity(), truck.getCarryingCapacity(), truck.getTruckType(), arrPortId));
                            }
                             if(vehicle.getType() == "Ship") {
                                vehicleCRUD.updateVehicle(vehicleId, new Ship(vehicleId, vehicle.getName(), vehicle.getCurrentFuel(), vehicle.getFuelCapacity(), vehicle.getCarryingCapacity(), arrPortId));
                            }
                        }
                            ...
                            if(vehicle.getType() == "Truck") {
                                Truck truck = (Truck) vehicle;
                                vehicleCRUD.updateVehicle(vehicleId, new Truck(vehicleId, truck.getName(), truck.getCurrentFuel(), truck.getFuelCapacity(), truck.getCarryingCapacity(), truck.getTruckType(), "none"));
                            }
                             if(vehicle.getType() == "Ship") {
                                vehicleCRUD.updateVehicle(vehicleId, new Ship(vehicleId, vehicle.getName(), vehicle.getCurrentFuel(), vehicle.getFuelCapacity(), vehicle.getCarryingCapacity(), "none"));
                            }
                        }
                            ...
                            if(vehicle.getType() == "Truck") {
                                Truck truck = (Truck) vehicle;
                                vehicleCRUD.updateVehicle(vehicleId, new Truck(vehicleId, truck.getName(), truck.getCurrentFuel(), truck.getFuelCapacity(), truck.getCarryingCapacity(), truck.getTruckType(), depPortId));
                            }
                             if(vehicle.getType() == "Ship") {
                                vehicleCRUD.updateVehicle(vehicleId, new Ship(vehicleId, vehicle.getName(), vehicle.getCurrentFuel(), vehicle.getFuelCapacity(), vehicle.getCarryingCapacity(), depPortId));
                            }
                        }
